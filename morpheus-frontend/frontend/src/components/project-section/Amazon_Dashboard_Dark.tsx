...
export default function AmazonDashboardDark({ processedData, className = "", style = {} as React.CSSProperties }: { processedData?: any; className?: string; style?: React.CSSProperties }) {
  ...
  return (
    <div className={`p-6 space-y-6 bg-gray-900 text-white rounded-[1px] border border-gray-700 shadow-sm overflow-hidden ${className}`} style={style}>
        ...
        <div className="p-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div>
              ...
              <Input className="rounded-[1px] border-gray-600 bg-gray-700 text-white placeholder-gray-400" type="date" value={dateFrom} onChange={(e)=>setDateFrom(e.target.value)} />
            </div>
            <div>
              <label className="text-xs text-gray-400">To</label>
              <Input className="rounded-[1px] border-gray-600 bg-gray-700 text-white placeholder-gray-400" type="date" value={dateTo} onChange={(e)=>setDateTo(e.target.value)} />
            </div>
            <div>
              <label className="text-xs text-gray-400">Search (SKU / Style / Category)</label>
              <div className="flex gap-2">
                <Input className="rounded-[1px] border-gray-600 bg-gray-700 text-white placeholder-gray-400" placeholder="e.g. KUR-1234 or Kurta" value={searchText} onChange={(e)=>setSearchText(e.target.value)} />
      ...
      <Tabs defaultValue="trend" className="w-full">
        <TabsList className="bg-gray-800 rounded-2xl p-1">
          <TabsTrigger className="rounded-[1px] data-[state=active]:text-white data-[state=active]:bg-gray-700 data-[state=active]:shadow-sm text-gray-300" value="trend">Revenue & Orders Trend</TabsTrigger>
          <TabsTrigger className="rounded-[1px] data-[state=active]:text-white data-[state=active]:bg-gray-700 data-[state=active]:shadow-sm text-gray-300" value="status">Status Mix</TabsTrigger>
          <TabsTrigger className="rounded-[1px] data-[state=active]:text-white data-[state=active]:bg-gray-700 data-[state=active]:shadow-sm text-gray-300" value="fulfill">Fulfillment</TabsTrigger>
          <TabsTrigger className="rounded-[1px] data-[state=active]:text-white data-[state=active]:bg-gray-700 data-[state=active]:shadow-sm text-gray-300" value="category">Category Share</TabsTrigger>
          <TabsTrigger className="rounded-[1px] data-[state=active]:text-white data-[state=active]:bg-gray-700 data-[state=active]:shadow-sm text-gray-300" value="geo">By State</TabsTrigger>
          <TabsTrigger className="rounded-[1px] data-[state=active]:text-white data-[state=active]:bg-gray-700 data-[state=active]:shadow-sm text-gray-300" value="skus">Top SKUs</TabsTrigger>
        </TabsList>
